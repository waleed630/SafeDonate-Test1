...
import { mockCampaignUpdates } from '../data/mockData';
    ...
    <div className="py-6 sm:py-10 px-4 sm:px-6 md:px-8 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-24 bg-white rounded-2xl p-6 border border-slate-100 shadow-sm">
            <div className="mb-6">
            ...
            <p className="text-slate-500 text-sm mb-6">234 donors</p>
            <button
      ...
      <Modal isOpen={showDonateModal} onClose={() => setShowDonateModal(false)} title="Make a Donation" size="md">
        <div className="space-y-6">
          ...
          <div className="border-t border-slate-100 pt-4 space-y-2">
            <button className="w-full py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-xl">
